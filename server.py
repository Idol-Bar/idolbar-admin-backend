...
def create_app():
    ...
    app.include_router(profile.router,dependencies=[Depends(AuthHandler)])
    app.include_router(client.router,dependencies=[Depends(AuthHandler)])
    ...
    app.include_router(food_category.router,dependencies=[Depends(AuthHandler)])
    app.include_router(notification.router,dependencies=[Depends(AuthHandler)])
    app.include_router(faq.router,dependencies=[Depends(AuthHandler)])
    ...
    app.include_router(payment.router,dependencies=[Depends(AuthHandler)])
    app.include_router(review.router,dependencies=[Depends(AuthHandler)])
    app.include_router(parcel.router,dependencies=[Depends(AuthHandler)])
